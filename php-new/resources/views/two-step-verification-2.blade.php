    ...
    <div class="account-content">
        <div class="login-wrapper account-bg reset-bg">
            <div class="login-content">
                <form method="get" class="digit-group login-form-control" data-group-name="digits" data-autosubmit="false"
                    autocomplete="off" action="deals-dashboard">
                    <div class="login-user-info">
                        ...
                        <div class="login-heading">
                            ...
                            <p class="verfy-mail-content">We sent a verification code to your email. Enter the code from the
            ...
            <div class="login-img">
                <img src="{{ URL::asset('/build/img/authentication/verify-img.png') }}" class="img-fluid" alt="Login">
            </div>
        </div>
    </div>
@endsection
