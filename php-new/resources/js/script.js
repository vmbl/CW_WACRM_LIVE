$(document).ready(function(){
	...
	//chat scripts
	$(".leadchats").click(function(){
        let leadId = $(this).attr("data-to");
        let fromId = $(this).attr("data-from");
		let name = $(this).attr("data-name");
		let lastmsg = $(this).attr("data-lastmsg");
		let tk = $(this).attr("data-tk")
        console.log(leadId, fromId);
		...
		$.ajax({
			type: "POST",
			url: '/usermessages', // This is what I have updated
			data: { _token: tk, leadid: leadId, name: name, lastmsg: lastmsg}
